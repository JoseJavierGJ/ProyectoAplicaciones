...
<body>
  ...
  <div class="content">
    <center><br>
    <h1 style= font-family:Poppins;>Ver información de los cursos</h1>
    <table border="1px">
        <tr>
        ...
        <tr>
            <td class="table_td" style="text-align: center;" style="font-family:Poppins;">
              <?php echo "{$info['name']}"?>
            </td>
            ...
            <td class="table_td" style="font-family:Poppins;">
              <?php
              echo "
