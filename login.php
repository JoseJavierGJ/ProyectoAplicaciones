...
<body background="./img/5.jpg" class="body_deg">
  <div class="home">
    <div class="btn-home">
  ...
  <center>
    <div class="form_deg">
      <center class="tittle_deg" style="font-family: Poppins; color: black;" color="blue;">
          Login Form
      ...
      <form action="login_check.php" method="POST" class="login_form">
        ...
        <div>
          <label class="label_deg" style="font-family: Poppins;">Username</label>
          <input type="text" name="username">
         </div>

         <div>
          <label class="label_deg" style="font-family: Poppins;">Password</label>
