...
<body>
  ...
  <div class="content">
    <center><br>
    <h1 style="font-family: Poppins;">Datos de Estudiante</h1>
    <?php
        if($_SESSION['message']){
    ...
    <table border="1px">
        <tr>
            <th class="table_th" style="font-family: Poppins;">Usuario</th>
            <th class="table_th" style="font-family: Poppins;">Correo</th>
            <th class="table_th" style="font-family: Poppins;">Teléfono</th>
            <th class="table_th" style="font-family: Poppins;">Contraseña</th>
            <th class="table_th" style="font-family: Poppins;">Borrar</th>
            <th class="table_th" style="font-family: Poppins;">Actualizar</th>
        </tr>
